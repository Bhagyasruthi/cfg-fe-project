...
var SekindoClientDetections_URL = function (config) {
	...
	this.setInfo();
				...
				var urlDetObj = new SekindoClientDetections_URL({
					url: 'https://live.sekindo.com/live/liveView.php?s=92825&cbuster=[CACHE_BUSTER]&pubUrl=[PAGE_URL_ENCODED]&x=300&y=300&vp_content=plembed5ddtwizprmno&vp_template=269&cbuster=1576260145',
					origQString: 's=92825&cbuster=[CACHE_BUSTER]&pubUrl=[PAGE_URL_ENCODED]&x=300&y=300&vp_content=plembed5ddtwizprmno&vp_template=269',
					x: 300,
					y: 300,
					isSlider: false,
					isOutstream: false,
